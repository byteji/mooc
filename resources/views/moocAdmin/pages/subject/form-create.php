                                    ...
                                    <div class="form-row">
                                        <div class="form-group col-md-3">
                                            ...
                                            <select class="custom-select mb-3" name="cat_name">
                                                ...
                                                <option value="sClass">Software</option>
                                                <option value="hClass">Hardware</option>
                                                <option value="nClass">Network</option>
                                                <option value="gClass">General</option>

                                            </select>
                                        </div>
                                        <div class="form-group col-md-9">
                                            <label for="p_name">ชื่อวิชา</label>
                                            <input type="text" class="form-control" name="p_name" id="p_name" placeholder="ชื่อวิชา" >
                                        </div>
                                        <div class="form-group col-md-3">
                                            <label for="price">อาจาร์ยผู้สอน</label>
                                            <input type="text" class="form-control" name="price" id="price" placeholder="ชื่อ">
                                        </div>
                                        <div class="form-group col-md-9">
                                            <label for="url">URL</label>
                                            <input type="text" class="form-control" name="url" id="url" placeholder="Url วิชา" >
                                        </div>
...
<script>
    $(function() {
        ...
        $('#formData').on('submit', function (e) {
            ...
            $.ajax({
                type: 'POST',
                url: '../../service/subject/create.php',
