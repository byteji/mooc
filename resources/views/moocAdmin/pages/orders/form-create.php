...
<head>
  ...
  <title> ตรวจสอบคนสำเร็จวิชา </title>
                                                ...
                                                <div class="row">
                                                    <div class="col-12">
                                                        <div class="form-group">
                                                            <label>ค้นหารายชื่อนักกเรียน</label>
                        ...
                        <div class="card shadow">
                            <div class="card-header border-0 pt-4">
                                ...
                                <button type="button" class="btn btn-success mt-3" data-toggle="modal" data-target="#modalAdd">
                                    <i class="fa fa-plus-circle"></i> เลือกวิชาที่ต้องการ
                                </button>
                                    ...
                                    <div class="modal-dialog modal-xl">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <h5 class="modal-title" id="exampleModalLabel">รายการวิชาทั้งหมด</h5>
    ...
    $(function() {
        ...
        function getsubject() {
            $.ajax({
                ...
                subject.append(`<tr><td colspan="5" class="text-center">ข้อมูลว่าง</td></tr>`)
            })
        }
