...
<head>
  ...
  <title> รายชื่ออาจาร์ย| CE Mooc </title>
                        ...
                        <div class="card shadow">
                            <div class="card-header border-0 pt-4">
                                ...
                                <a href="form-create.php" class="btn btn-primary mt-3">
                                 ...
                                 <a href="form-register.php" class="btn btn-success mt-3">
                                    <i class="fas fa-plus"></i>
        ...
        function initDataTables(tableData) {
            $('#logs').DataTable( {
                ...
                columns: [
                    ...
                    { title: "คำนำหน้า" , className: "align-middle"}, //
                    ...
                    $(document).on('click', '#delete', function(){ 
                        ...
                        Swal.fire({
                            ...
                            if (result.isConfirmed) {
                                $.ajax({  
                                    type: "DELETE",  
                                    url: "../../service/teacher/delete.php",  
                                    data: { id: id }
                                }).done(function() {
                                    Swal.fire({
