...
<head>
  ...
  <title>แก้ไขรายชื่ออาจาร์ย| CE Mooc</title>
                                ...
                                <div class="card-body">
                                    <div class="row">
                                        ...
                                        <div class="col-md-6 px-1 px-md-5">
                                            ...
                                            <div class="form-group">
                                                <label for="permission">คำนำหน้า</label>
                                                <select class="form-control" name="title" id="title" required>
                                                    <option value disabled selected>คำนำหน้า</option>
                                                    <option value="ta1">อ</option>
                                                    <option value="ta2">ผศ.</option>
                                                    <option value="ta3">รศ.</option>
                                                    <option value="ta4">ศ.</option>
                                                </select>
                                            </div>

                                            <div class="form-group">
                                                <label for="customFile">อัพโหลดลายเซ็น</label>
...
<script>
     $(function() {
        $('#formData').on('submit', function (e) {
            ...
            $.ajax({
                type: 'PUT',
                url: '../../service/teacher/update.php',
